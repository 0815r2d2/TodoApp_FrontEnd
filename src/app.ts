...
export class App {
  ...
  configureRouter(config: RouterConfiguration, router: Router): void {
    config.title = 'Title';
    config.map([
      { route: ['', 'home'], name: 'home', nav: true, moduleId: PLATFORM.moduleName('./resources/home/home'), title: 'Home', settings: { data: this } },
  ...
  setNavigationToAuthUser(authUser: boolean): void {
    if (authUser) {
      ...
      this.router.addRoute({ route: 'logout', name: 'logout', nav: true, moduleId: PLATFORM.moduleName('./resources/logout-user/logout-user'), title: 'Logout', settings: { data: this } });
    } else {
      //delete Auth Routes
